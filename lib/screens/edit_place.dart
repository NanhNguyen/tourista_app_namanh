...
class _EditPlaceState extends State<EditPlace> {
  ...
  @override
  void initState() {
    placeIDController.text = widget.place.id.toString();
    placeNameController.text = widget.place.name;
    placeAddressController.text = widget.place.location;
    placeDescriptionController.text = widget.place.description;
    super.initState();
  }
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  GestureDetector(
                    onTap: () {
                      TravelPlaceFirebaseService.editTravelPlace(
